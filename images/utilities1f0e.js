var ajax = 'https://binasbeautysalon.weebly.com/ajax/publicBackend.php';
var comment = { };
...
function blogCommentDisplayForm(url, wrapperId, commentId) {
    var wrapper = $(wrapperId),
        ...
        cancelText = _W.utl('html.weebly.images.common.weebly_1');
...
function blogCommentCreateCancelOverlay(wrapperId, commentId) {
    ...
    if (button) {
        ...
        }).update(_W.utl('html.weebly.images.common.weebly_2')).observe('click', function() {
